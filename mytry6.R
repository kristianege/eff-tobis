...
colnames(test4)<-c(names(test4)[1:2],paste("inc",names(test4)[3:6],sep="_"))
colnames(test5)<-c(names(test5)[1:2],paste("slope",names(test5)[3:6],sep="_"))
colnames(test6)<-c(names(test6)[1:2],paste("model",names(test6)[3:13],sep="_"))
...
source("C:\\EFF_korttidsprog_tobis\\Larve_otolitter\\R-scripts\\ALL_DATA_larvae_id.R")
...
source("C:\\EFF_korttidsprog_tobis\\Larve_otolitter\\R-scripts\\best_ages.R")
...
source("C:\\EFF_korttidsprog_tobis\\Larve_otolitter\\R-scripts\\Assembly_length_meta_area.R")
